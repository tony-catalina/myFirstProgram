...
define(function (require) {
    ...
    var formtpl = require('services/form/_emglWjcp.html');
    var hideshow = require('modules/showHideClumn');
    var combox = require('awd/easyui/combox');
    var hdpzFormAdd = require('modules/form/emglWjcb');
        ...
        layout: function () {
                ...
                buttons: [
                    {
                        ...
                        fun: function () {
                            ...
                            if (data) {
                                hdpzFormAdd.init(url.emdjAdd, data, function () {
                                    grid.reload('table');
                                 });
                            } else {
                                utils.alert("请选择人员");
            ...
            searchform.init('search',{
                ...
                query:function(param){
                    param=$.extend({},{'emlx_notin':'01,02'},param);
                    grid.query('table',param);
                }
            });

            jbxxgrid.initjbxx('table', false, 200, {'emlx_notin':'01,02'}, function (rybh) {
            });
