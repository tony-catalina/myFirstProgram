...
define(function(require) {
    ...
    var main = {
        ...
        generalScene:function ( element, api, flowConfig) {
          ...
          config[0].data[0].extData.events = data.KSS_GWJJB_JBDJ;
          config[0].data[1].extData.events = data.KSS_GWJJB_JBLDQR;
          config[0].data[2].extData.events = data.KSS_GWJJB_JBQR;
          // config[0].data[3].extData.events = data.KSS_GWJJB_JLDQR;
              ...
              on: {
                click: function ( target, e ) {
                  ...
                  if(target[0].case.options.name == "交班"|| target[0].case.options.text =="交班"){
                    window.parent.parent.openTab('交班','/apps/kss/views/pages/gwjjb/jb.html' );
                  }
                  if(target[0].case.options.name == "接班"|| target[0].case.options.text =="接班"){
                    window.parent.parent.openTab('接班','/apps/kss/views/pages/gwjjb/gb.html'  );
                  }
                  if(target[0].case.options.name == "领导查看"|| target[0].case.options.text =="领导查看"){
                    window.parent.parent.openTab('领导查看','/apps/kss/views/pages/gwjjb/ldck.html' );
                  }
