...
define(function(require){
    ...
    var add = require('services/form/_zbypsqgjsp.html');
    var gjspForm = require('modules/form/zbypsqGjsp');
    ...
    var main={
        ...
        layout:function(){
                ...
                buttons:[
                    {id:'add',name:'审批',icon:'icon-jiahao',fun:function(){
                        var data = grid.getSelected('table')[0];
                            if(data) {
                                gjspForm.init(url.gjSp,data, function() {
                                  var param = {
                                        'taskDefinitionKey': 'kss_zbypsq_gjsp',
            ...
            jbxxgrid.initJbxxflow('table',false,200,{'taskDefinitionKey':'kss_zbypsq_gjsp','processDefinitionKey':'kss_zbypsq'},function(rybh) {   //流程中的节点使用这个
            });
