...
define(function (require) {
    ...
    var gbjyJxcxForm = require('modules/form/gbjyJxcx');
    ...
    var main = {
        ...
        layout: function () {
            ...
            toolbar.init({
                buttons: [
                    {
                        id: 'jxcxAdd', name: '谈话教育登记', icon: 'icon-jiahao',ryyw:true, fun: function () {
                            var data = grid.getSelected('table')[0];
                            if (data) {
                                gbjyJxcxForm.init(url.thjyAdd, data, function () {
            ...
            jbxxgrid.initjbxx('table',false,300, {state:'R8'},function(rybh) {
