...
define(function (require) {
    ...
    var hdpzFormAdd = require('modules/form/zdryRywh');
    ...
    var main = {
        ...
        layout: function () {
            ...
            toolbar.init({
                buttons: [
                    {
                        id: 'add', name: '人员维护', icon: 'icon-jiahao', ryyw: true, fun: function () {
                            ...
                            if (data) {
                                ...
                                hdpzFormAdd.init(url.zdryAdd, addData, function () {
                                    grid.reload('table');
                                 });
                            } else {
                                utils.alert("请选择人员");
            ...
            jbxxgrid.initjbxx('table', false, 200, { state: 'R8', zdry: '1' }, function (rybh) {
                console.log(rybh);
            });
