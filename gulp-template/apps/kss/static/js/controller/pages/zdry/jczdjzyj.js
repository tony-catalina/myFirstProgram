...
define(function (require) {
    ...
    var hdpzFormAdd = require('modules/form/zdryJczdjzyj');
        ...
        layout: function () {
            ...
            searchform.init('search', {
                query: function (param) {
                    param = $.extend({}, {
                        'taskDefinitionKey': 'kss_zdrycx_zdjzyj',
            ...
            jbxxgrid.initJbxxflow('table',false,200,{'taskDefinitionKey':'kss_zdrycx_zdjzyj','processDefinitionKey':'kss_zdrycx'},function(rybh) {   //流程中的节点使用这个
            });
            /**布局初始化**/
        },
        eventBind: function () {
