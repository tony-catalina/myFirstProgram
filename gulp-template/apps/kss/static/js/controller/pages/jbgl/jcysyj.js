...
define(function(require){
    ...
    var jbjcYsyjForm=require('modules/form/jbjcYsyj');
        ...
        layout:function(){
                ...
                buttons:[
                    {
                        ...
                        fun:function(){
                            ...
                            if(data) {
                                ...
                                jbjcYsyjForm.init(url.ldspAddByGj, postData, function () {
                                    grid.reload('table')
                                });
                            }else {
                                utils.alert('请选择人员');
            ...
            searchform.init('search',{
                query:function(param){
                    param=$.extend({},{
                        'taskDefinitionKey':'kss_jbjc_ysyj',
            ...
            jbxxgrid.initJbxxflow('table',false,200,{'taskDefinitionKey':'kss_jbjc_ysyj','processDefinitionKey':'kss_jbjc'},function(rybh) {   //流程中的节点使用这个
            });
