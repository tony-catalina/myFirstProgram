...
define(function(require){
    ...
    var dlsyflbrForm = require('modules/form/yrshzd');
    ...
    var main={
        ...
        layout:function(){
                ...
                buttons:[
                    {id:'add',name:'新增',icon:'icon-jiahao',fun:function(){
                        ...
                        if (data) {
                            ...
                            var addData1 = {kssj:currentTime,jssj:currentTime};
                            var addData = {};
                            Object.assign(addData, data, addData1);
                            dlsyflbrForm.init(url.qybzAdd, addData, function () {
                                grid.reload('table');
                            });
                        } else {
                            utils.alert('请选择要晒被褥的人员!');
                        }
            ...
            grid.init('table',{
                url: url.qybzList+'?bzlx=带领晾晒衣服被褥',
                fit: false,
                width: '100%',
                height: '350',
                firstLoad: false,
