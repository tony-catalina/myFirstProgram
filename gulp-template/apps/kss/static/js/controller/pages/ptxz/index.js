...
define(function(require){
    ...
    var add = require('services/form/_ptxz.html');
    ...
    require('layer.config');
    var ptxzForm = require('modules/form/ptxz');
    ...
    var main={
        ...
        layout:function(){
            ...
            toolbar.init({
                buttons:[
                    {id:'add',name:'新增',icon:'icon-jiahao',ryyw:true,fun:function(){
                            ...
                            if(data) {
                                Object.assign(data);
                                ptxzForm.init(url.qybzAdd, data,function() {
                                    grid.reload('table');
                                });
                            }else {
                                utils.alert('请选择人员');
            ...
            grid.init('table',{
                url: url.ptxzqybzList+"?bzlx=陪同巡诊",
                fit: false,
                width: '100%',
                height: window.innerHeight - 200,
                firstLoad: false,
                columns: clumn( {check:false,
                    clumns:['bzlx','qy','jsh','kssj','jssj','mjxm','dlys'],
                    hidden:[]})
            });
            hideshow.init('modules/clumn/qybz',['bzlx','qy','jsh','kssj','jssj','mjxm','dlys'],[]);
