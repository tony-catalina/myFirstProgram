...
define(function(require){
    ...
    var add = require('services/form/_ylxxblSqbl.html');
    ...
    var ylxxblSqblForm=require('modules/form/ylxxblSqbl');
    ...
    var main={
        ...
        layout:function(){
            ...
            toolbar.init({
                buttons:[
                    {id:'add',name:'伤情登记',icon:'icon-jiahao',ryyw:true,fun:function(){
                        var data = grid.getSelected('table')[0];
                        if(data) {
                            ylxxblSqblForm.init(url.sqdjAdd, data, function() {
