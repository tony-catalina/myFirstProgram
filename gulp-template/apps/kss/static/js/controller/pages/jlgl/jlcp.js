...
define(function (require) {
    ...
    var hdpzFormAdd = require('modules/form/jlglJlcp');
                ...
                buttons: [
                    {
                        ...
                        fun: function () {
                            ...
                            if (data) {
                                ...
                                var addData1 = { jbsj: currentTime, jbr: common.info.user.loginname };
                                var addData = {};
                                Object.assign(addData, data, addData1);
                                hdpzFormAdd.init(url.jlcpAdd, addData, function () { });
                            } else {
                                utils.alert("请选择人员");
                            }
                        }
