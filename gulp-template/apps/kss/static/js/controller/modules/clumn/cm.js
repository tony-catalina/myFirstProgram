 ...
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'wdrybh')>-1){
	            clumns.push({field : 'wdrybh',title : '点名未到人员编号',width : 200,hidden:util.getArrayIndex(option.hidden,'wdrybh')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.wdrybh==null?"":row.wdrybh)+'>'+(row.wdrybh==null?"":row.wdrybh)+'</span>'}});
	        }
