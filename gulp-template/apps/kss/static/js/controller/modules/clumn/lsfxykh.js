 ...
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'khdj')>-1){
	            clumns.push({field : 'khdj',title : '考核等级',width : 200,hidden:util.getArrayIndex(option.hidden,'khdj')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.khdj==null?"":row.khdj)+'>'+(row.khdj==null?"":row.khdj)+'</span>'}});
	        }
