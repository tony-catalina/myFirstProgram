 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'gynr')>-1){
	            clumns.push({field : 'gynr',title : '干预内容',width : 200,hidden:util.getArrayIndex(option.hidden,'gynr')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.gynr==null?"":row.gynr)+'>'+(row.gynr==null?"":row.gynr)+'</span>'}});
	        }
