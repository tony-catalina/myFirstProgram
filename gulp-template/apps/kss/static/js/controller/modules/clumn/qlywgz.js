 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'gznr')>-1){
	            clumns.push({field : 'gznr',title : '告知内容',width : 200,hidden:util.getArrayIndex(option.hidden,'gznr')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.gznr==null?"":row.gznr)+'>'+(row.gznr==null?"":row.gznr)+'</span>'}});
	        }
