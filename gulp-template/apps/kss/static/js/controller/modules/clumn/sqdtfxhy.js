 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'hysj')>-1){
	            clumns.push({field : 'hysj',title : '会议时间',width : 200,hidden:util.getArrayIndex(option.hidden,'hysj')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.hysj==null?"":row.hysj)+'>'+(row.hysj==null?"":row.hysj)+'</span>'}});
	        }
