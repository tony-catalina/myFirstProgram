 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'zssqyw')>-1){
	            clumns.push({field : 'zssqyw',title : '有无伤病自述',width : 200,hidden:util.getArrayIndex(option.hidden,'zssqyw')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.zssqyw==null?"":row.zssqyw)+'>'+(row.zssqyw==null?"":row.zssqyw)+'</span>'}});
	        }
