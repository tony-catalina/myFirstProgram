 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'zwh')>-1){
	            clumns.push({field : 'zwh',title : '座位号',width : 200,hidden:util.getArrayIndex(option.hidden,'zwh')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.zwh==null?"":row.zwh)+'>'+(row.zwh==null?"":row.zwh)+'</span>'}});
	        }
