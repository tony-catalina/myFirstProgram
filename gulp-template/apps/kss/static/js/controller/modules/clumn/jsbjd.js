 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'sfsjsbString')>-1){
                clumns.push({field : 'sfsjsbString',title : '是否是精神病',width : 200,hidden:util.getArrayIndex(option.hidden,'sfsjsbString')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.sfsjsbString==null?"":row.sfsjsbString)+'>'+(row.sfsjsbString==null?"":row.sfsjsbString)+'</span>'}});
            }
