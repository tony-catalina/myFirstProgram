 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
			...
			if(util.getArrayIndex(option.clumns,'jcjgString')>-1){
                clumns.push({field : 'jcjgString',title : '检查结果',width : 200,hidden:util.getArrayIndex(option.hidden,'jcjgString')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.jcjgString==null?"":row.jcjgString)+'>'+(row.jcjgString==null?"":row.jcjgString)+'</span>'}});
            }
