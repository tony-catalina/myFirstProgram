 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'clcs')>-1){
	            clumns.push({field : 'clcs',title : '处理措施',width : 200,hidden:util.getArrayIndex(option.hidden,'clcs')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.clcs==null?"":row.clcs)+'>'+(row.clcs==null?"":row.clcs)+'</span>'}});
	        }
