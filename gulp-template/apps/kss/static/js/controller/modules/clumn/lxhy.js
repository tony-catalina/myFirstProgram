 ...
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'lxhysj')>-1){
	            clumns.push({field : 'lxhysj',title : '会议时间',width : 200,hidden:util.getArrayIndex(option.hidden,'lxhysj')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.lxhysj==null?"":row.lxhysj)+'>'+(row.lxhysj==null?"":row.lxhysj)+'</span>'}});
	        }
