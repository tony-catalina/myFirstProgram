define(function(require) {
    ...
    var formtpl = require('services/form/_jbgljcysyj.html');
    ...
    var main = {
        init: function(url,data,callback) {
            // console.log('data')
            // console.log(data)
            var html = formtpl('form/_jbgljcysyj',data);
            if(!isOpen){
        ...
        bindEvent: function() {
            ...
            $("#blsj").datebox().datebox("setValue",nowDate);
        ...
        submit: function(url,data, callback) {
            ...
            if ($('#fm').form('validate')) {
                ...
                postData.processNode='kss_jbjc_ysyj';
