define(function (require) {
    ...
    var formtpl = require('services/form/_syrsSykz.html');
    ...
    var main = {
        ...
        init: function (url, data, callback) {
            var html = formtpl('form/_syrsSykz', data);
            if(!isOpen) {
        ...
        bindEvent: function () {
            $("#syr").textbox().textbox('setValue',common.info.user.loginname);
            $("#bar").textbox().textbox('setValue',common.info.user.loginname);
            $("#jbr").textbox().textbox('setValue',common.info.user.loginname);
            $("#hztfr").textbox().textbox('setValue',common.info.user.loginname);
        },
