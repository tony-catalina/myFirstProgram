define(function(require) {
    ...
    var formtpl = require('services/form/_ygryszldsp.html');
    ...
    var main = {
        init: function(url,data,callback) {
            var html = formtpl('form/_ygryszldsp',data);
         if(!isOpen){
        ...
        submit: function(url,data, callback) {
           // debugger
            ...
            if ($('#fm').form('validate')) {
                ...
                postData.processName = 'kss_ygsz';
                postData.processNode = 'kss_ygsz_ldsp';
                util.ajax({
                    url: url,
                    data: postData,
                    func: function(data) {
