define(function (require) {
    ...
    var formtpl = require('services/form/_cfglzdjsyj.html');
    ...
    var main = {
        ...
        init: function (url, data, row, callback) {
            ...
            var html = formtpl('form/_cfglzdjsyj', dataall);
           if(!isOpen){
        ...
        bindEvent: function () {
            ...
            $("#zdzpssj").datetimebox("setValue",(new Date()).Format("yyyy-MM-dd hh:mm:ss"));
        ...
        submit: function (url,jbxx, callback) {
            console.log("========"+JSON.stringify(jbxx));
            /**先校验form */
            if ($('#fm').form('validate')) {
