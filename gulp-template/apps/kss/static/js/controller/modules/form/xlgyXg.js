define(function(require) {
    ...
    var formtpl = require('services/form/_xlgyXg.html');
    ...
    var popwin;
    var main = {
        init: function(url,data,jl,callback,title) {
            var html = formtpl('form/_xlgyXg',data,jl);
          if(!isOpen){
        ...
        bindEvent: function(jl) {
            ...
            $("#gynrfm").textbox('setValue',jl.gynr);
