define(function(require) {
    ...
    var formtpl = require('services/form/_xjsyYcLdsp.html');
    ...
    var main = {
        init: function(url,data,callback) {
            var html = formtpl('form/_xjsyYcLdsp',data);
           if(!isOpen){
        ...
        bindEvent: function() {
            $("#ycldsprfm").textbox().textbox('setValue',common.info.user.loginname);
            var nowDate=(new Date()).Format("yyyy-MM-dd hh:mm:ss");
            $("#ycldspsjfm").datetimebox().datetimebox("setValue",nowDate);
