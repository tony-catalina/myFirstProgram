define(function(require) {
    ...
    var formtpl = require('services/form/_jyglZyzlqr.html');
    ...
    var main = {
        init: function(url,data,callback) {
            var html = formtpl('form/_jyglZyzlqr',data);
           if(!isOpen) {
                    ...
                    success: function() {
                        ...
                        Array.from(document.getElementsByClassName('timeline-item')).reduce(function (p, el, idx) {
                            return p.then(function () {
                                return commFun.processQueued(el.querySelectorAll('.easyui-textbox,  .easyui-combobox'),function(el){
