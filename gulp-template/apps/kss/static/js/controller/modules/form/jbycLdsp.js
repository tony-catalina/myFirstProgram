define(function(require) {
    ...
    var formtpl = require('services/form/_jbglYcldsp.html');
    ...
    var main = {
        init: function(url,data,callback) {
            var html = formtpl('form/_jbglYcldsp',data);
          if(!isOpen){
        ...
        submit: function(url,data, callback) {
            ...
            if ($('#fm').form('validate')) {
                ...
                postData.processName='kss_jbyc';
                postData.processNode='kss_jbyc_zdzyj';
