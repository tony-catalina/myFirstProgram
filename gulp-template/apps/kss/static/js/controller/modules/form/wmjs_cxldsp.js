define(function(require) {
    ...
    var formtpl = require('services/form/_wmjsLdsp.html');
    ...
    var main = {
        init: function(url,data,callback) {
            var html = formtpl('form/_wmjsLdsp',data);
            if(!isOpen) {
        ...
        submit: function(url,data, callback) {
            ...
            if ($('#fm').form('validate')) {
                ...
                postData.processName = "kss_wmjscx";
                postData.processNode = "kss_wmjscx_ldsp";
                util.ajax({
                    url: url,
                    data: postData,
                    func: function(data) {
