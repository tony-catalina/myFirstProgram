define(function (require) {
    ...
    var formtpl = require('services/form/_shglShjb.html');
    ...
    var main = {
        init: function (url, data, callback) {
            var html = formtpl('form/_shglShjb', data);
            if(!isOpen) {
        ...
        bindEvent: function () {
            ...
            $("#jbsj").datetimebox().datetimebox('setValue',(new Date()).Format('yyyy-MM-dd hh:mm:ss'));
        },
