define(function(require) {
    ...
    var formtpl = require('services/form/_jshjJqtrdj.html');
    ...
    var main = {
        init: function(url,data,callback) {
            var html = formtpl('form/_jshjJqtrdj',data);
            if(!isOpen) {
        ...
        bindEvent: function() {
            ...
            $("#hjsj").datetimebox().datetimebox("setValue",(new Date()).Format("yyyy-MM-dd hh:mm:ss"));
