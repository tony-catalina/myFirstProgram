define(function(require) {
    ...
    var formtpl = require('services/form/_ryypgm.html');
    ...
    var main = {
        init: function(url,data,callback) {
            data.ypmcurl = urls.getKcYpmcList;
            var html = formtpl('form/_ryypgm',data);
            if(!isOpen) {
        ...
        submit: function(url,data, callback) {
            ...
            if ($('#fm').form('validate')) {
                ...
                // postData.sqyy='';
                // postData.createTime= (new Date()).format("yyyy-MM-dd");
                postData.createtime="";
                postData.creator ="";
                util.ajax({
                    url: url,
