define(function (require) {
    ...
    var formtpl = require('services/form/_lscsHsqd.html');
    ...
    var main = {
        ...
        init: function (url, data, rows, callback) {
            var html = formtpl('form/_lscsHsqd', data);
            if(!isOpen) {
        ...
        bindEvent: function (_jbxx) {
            ...
            formTable.init("Table_ryxx", _jbxx, [
                ['监室号', '姓名', '关押期限', '办案环节', '当前办案单位', '当前办案单位类型','出所原因','出所去向'],
                ['jsh', 'xm', 'gyqx', 'bahjString', 'badw', 'dwlxString','csyyString','csqx']
            ]);
