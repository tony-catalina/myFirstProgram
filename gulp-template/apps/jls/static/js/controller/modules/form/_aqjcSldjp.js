define(function (require) {
    ...
    var formtpl = require('services/form/_aqjcSldjp.html');
    ...
    var main = {
        ...
        init: function (url, data, row, callback) {
            ...
            var html = formtpl('form/_aqjcSldjp', dataall);
            if(!isOpen) {
        ...
        bindEvent: function () {
            ...
            $("#jpldfm").textbox("setValue",common.info.user.loginname);
            var nowDate=(new Date()).Format("yyyy-MM-dd hh:mm:ss");
            console.log(nowDate);
            $("#jpsjfm").datetimebox("setValue",nowDate);
