 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'rsyy')>-1){
	            clumns.push({field : 'rsyy',title : '入所原因',width : 200,hidden:util.getArrayIndex(option.hidden,'rsyy')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.rsyy==null?"":row.rsyy)+'>'+(row.rsyy==null?"":row.rsyy)+'</span>'}});
	        }
