 ...
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'xlzxs')>-1){
	            clumns.push({field : 'xlzxs',title : '心理咨询师',width : 200,hidden:util.getArrayIndex(option.hidden,'xlzxs')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.xlzxs==null?"":row.xlzxs)+'>'+(row.xlzxs==null?"":row.xlzxs)+'</span>'}});
	        }
