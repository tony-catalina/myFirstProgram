 ...
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'lyjsx')>-1){
	            clumns.push({field : 'lyjsx',title : '理由及事项',width : 200,hidden:util.getArrayIndex(option.hidden,'lyjsx')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.lyjsx==null?"":row.lyjsx)+'>'+(row.lyjsx==null?"":row.lyjsx)+'</span>'}});
	        }
	        ...
	        if(util.getArrayIndex(option.clumns,'zz1')>-1){
	            clumns.push({field : 'zz1',title : '住址1',width : 200,hidden:util.getArrayIndex(option.hidden,'zz1')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.zz1==null?"":row.zz1)+'>'+(row.zz1==null?"":row.zz1)+'</span>'}});
	        }
	        if(util.getArrayIndex(option.clumns,'zjh1')>-1){
	            clumns.push({field : 'zjh1',title : '证件号1',width : 200,hidden:util.getArrayIndex(option.hidden,'zjh1')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.zjh1==null?"":row.zjh1)+'>'+(row.zjh1==null?"":row.zjh1)+'</span>'}});
	        }
	        ...
	        if(util.getArrayIndex(option.clumns,'gx2')>-1){
	            clumns.push({field : 'gx2',title : '关系',width : 200,hidden:util.getArrayIndex(option.hidden,'gx2')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.gx2==null?"":row.gx2)+'>'+(row.gx2==null?"":row.gx2)+'</span>'}});
	        }
	        if(util.getArrayIndex(option.clumns,'zz2')>-1){
	            clumns.push({field : 'zz2',title : '住址2',width : 200,hidden:util.getArrayIndex(option.hidden,'zz2')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.zz2==null?"":row.zz2)+'>'+(row.zz2==null?"":row.zz2)+'</span>'}});
	        }
	        if(util.getArrayIndex(option.clumns,'zjh2')>-1){
	            clumns.push({field : 'zjh2',title : '证件号2',width : 200,hidden:util.getArrayIndex(option.hidden,'zjh2')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.zjh2==null?"":row.zjh2)+'>'+(row.zjh2==null?"":row.zjh2)+'</span>'}});
	        }
	        ...
	        if(util.getArrayIndex(option.clumns,'gx3')>-1){
	            clumns.push({field : 'gx3',title : '关系',width : 200,hidden:util.getArrayIndex(option.hidden,'gx3')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.gx3==null?"":row.gx3)+'>'+(row.gx3==null?"":row.gx3)+'</span>'}});
	        }
	        if(util.getArrayIndex(option.clumns,'zz3')>-1){
	            clumns.push({field : 'zz3',title : '住址3',width : 200,hidden:util.getArrayIndex(option.hidden,'zz3')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.zz3==null?"":row.zz3)+'>'+(row.zz3==null?"":row.zz3)+'</span>'}});
	        }
	        if(util.getArrayIndex(option.clumns,'zjh3')>-1){
	            clumns.push({field : 'zjh3',title : '证件号3',width : 200,hidden:util.getArrayIndex(option.hidden,'zjh3')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.zjh3==null?"":row.zjh3)+'>'+(row.zjh3==null?"":row.zjh3)+'</span>'}});
	        }
