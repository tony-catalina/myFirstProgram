 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'yyry')>-1){
	            clumns.push({field : 'yyry',title : '预约人员',width : 200,hidden:util.getArrayIndex(option.hidden,'yyry')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.yyry==null?"":row.yyry)+'>'+(row.yyry==null?"":row.yyry)+'</span>'}});
	        }
