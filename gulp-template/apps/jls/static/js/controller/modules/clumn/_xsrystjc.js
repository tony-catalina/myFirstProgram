 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'jcmj')>-1){
	            clumns.push({field : 'jcmj',title : '检查民警',width : 200,hidden:util.getArrayIndex(option.hidden,'jcmj')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.jcmj==null?"":row.jcmj)+'>'+(row.jcmj==null?"":row.jcmj)+'</span>'}});
	        }
