 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'ztpj')>-1){
	            clumns.push({field : 'ztpj',title : '总体评价',width : 200,hidden:util.getArrayIndex(option.hidden,'ztpj')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.ztpj==null?"":row.ztpj)+'>'+(row.ztpj==null?"":row.ztpj)+'</span>'}});
	        }
