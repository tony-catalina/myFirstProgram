 ...
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'gxrxm')>-1){
	            clumns.push({field : 'gxrxm',title : '关系人姓名',width : 200,hidden:util.getArrayIndex(option.hidden,'gxrxm')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.gxrxm==null?"":row.gxrxm)+'>'+(row.gxrxm==null?"":row.gxrxm)+'</span>'}});
	        }
