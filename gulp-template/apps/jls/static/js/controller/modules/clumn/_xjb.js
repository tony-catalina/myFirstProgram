 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'ycqkms')>-1){
	            clumns.push({field : 'ycqkms',title : '异常情况描述',width : 200,hidden:util.getArrayIndex(option.hidden,'ycqkms')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.ycqkms==null?"":row.ycqkms)+'>'+(row.ycqkms==null?"":row.ycqkms)+'</span>'}});
	        }
