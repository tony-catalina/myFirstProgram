 ...
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'fkzt')>-1){
	            clumns.push({field : 'fkzt',title : '反馈状态',width : 200,hidden:util.getArrayIndex(option.hidden,'fkzt')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.fkzt==null?"":row.fkzt)+'>'+(row.fkzt==null?"":row.fkzt)+'</span>'}});
	        }
