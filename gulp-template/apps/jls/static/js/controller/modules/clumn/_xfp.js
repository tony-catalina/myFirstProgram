 ...
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'code')>-1){
	            clumns.push({field : 'code',title : 'code',width : 200,hidden:util.getArrayIndex(option.hidden,'code')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.code==null?"":row.code)+'>'+(row.code==null?"":row.code)+'</span>'}});
	        }
