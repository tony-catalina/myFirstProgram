 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'bqlb')>-1){
	            clumns.push({field : 'bqlb',title : '病情类别',width : 200,hidden:util.getArrayIndex(option.hidden,'bqlb')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.bqlb==null?"":row.bqlb)+'>'+(row.bqlb==null?"":row.bqlb)+'</span>'}});
	        }
