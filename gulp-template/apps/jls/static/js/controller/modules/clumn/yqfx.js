 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'xysq')>-1){
	            clumns.push({field : 'xysq',title : '分析时期',width : 200,hidden:util.getArrayIndex(option.hidden,'xysq')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.xysq==null?"":row.xysq)+'>'+(row.xysq==null?"":row.xysq)+'</span>'}});
	        }
