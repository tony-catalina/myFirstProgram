 ...
 */
 define(function (require) {
	    ...
	    var main=function(option){
	        ...
	        if(util.getArrayIndex(option.clumns,'fyqk')>-1){
	            clumns.push({field : 'fyqk',title : '反应情况',width : 200,hidden:util.getArrayIndex(option.hidden,'fyqk')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.fyqk==null?"":row.fyqk)+'>'+(row.fyqk==null?"":row.fyqk)+'</span>'}});
	        }
	        if(util.getArrayIndex(option.clumns,'jcjd')>-1){
	            clumns.push({field : 'jcjd',title : '奖惩决定',width : 200,hidden:util.getArrayIndex(option.hidden,'jcjd')>-1?true:false,sortable:'true',formatter: function(value,row,index){return '<span title='+(row.jcjd==null?"":row.jcjd)+'>'+(row.jcjd==null?"":row.jcjd)+'</span>'}});
	        }
