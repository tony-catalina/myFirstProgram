...
define(function(require){
    ...
    var formtpl=require('services/form/_jstzZgsldyj.html');
    ...
    var form=require('modules/form/_jstzZgsldyj');

        
    require('layer.config');
    var utils = require('awd/layui/utils');
    var combox = require('awd/easyui/combox');
    var hdpzFormAdd = require('modules/form/_jstzZgsldyj');
            ...
            toolbar.init({
                buttons:[
                    {id:'add',name:'办理登记',icon:'icon-jiahao',fun:function(){
                        ...
                        if (data) {
                            hdpzFormAdd.init(url.jstzexecuteflow, data, function() {grid.reload('table');});
                        } else {
                            utils.alert("请选择人员");
                        }
                    }}
            ...
            searchform.initLc('search',{
                ...
                query: function (param) {
                    param = $.extend({}, {
                        ...
                        'taskDefinitionKey': 'jls_jstz_sldyj',
                        'state': 'R8'
                    }, param);
