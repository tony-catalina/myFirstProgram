...
define(function(require){
    ...
    var formtpl=require('services/form/_jstzJstzqr.html');
    ...
    var form=require('modules/form/_jstzJstzqr');


    require('layer.config');
    var utils = require('awd/layui/utils');
    var combox = require('awd/easyui/combox');
    var hdpzFormAdd = require('modules/form/_jstzJstzqr');
            ...
            searchform.initLc('search',{
                ...
                query: function (param) {
                    param = $.extend({}, {
                        ...
                        'taskDefinitionKey': 'jls_jstz_jstzqr',
                        'state': 'R8'
                    }, param);
