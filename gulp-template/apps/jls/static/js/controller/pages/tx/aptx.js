...
define(function(require){
    ...
    var form=require('modules/form/_txAptx');

    require('layer.config');
    var utils = require('awd/layui/utils');
    var combox = require('awd/easyui/combox');
    var hdpzFormAdd = require('modules/form/_txAptx');
    ...
    var main={
        ...
        layout:function(){
            ...
            toolbar.init({
                buttons: [
                    { id: 'add', name: '办理登记', icon: 'icon-taizhang', fun: function() {
                        ...
                        if (data) {
                            hdpzFormAdd.init(url.aptxSave, data, function() {
                                grid.reload('table');
                            });
                        } else {
                            utils.alert("请选择人员");
            ...
            //     columns: clumn({
            //         check: false,
            //         clumns: ['xm','jsh','bm','xb','rsrq','rsxz','badw','ayString','bar','bardh','gyqx','gyts','hjd',
            ...
            //     })
            // });
            // hideshow.init('modules/clumn/jbxx',['xm','jsh','bm','xb','rsrq','rsxz','badw','ayString','bar','bardh','gyqx','gyts','hjd',
            // 'hyzk','mz','sf','tssf','whcd','xzd','zjlx','zjh','zy','zzmm','gzdw','hjdxz',
            // 'jljdjg','jlrq','jyaq','pzajbh','pzflwsh','pzrybh','sdnjccjg','sdnjcjsj','sdnjdw','sdnjjcr',
            // 'sypz','sypzwsh','syr'],['rsxz','bar','bardh','hjd','hyzk','mz','sf','tssf','whcd','xzd','zjlx','zjh',
            // 'zy','zzmm','gzdw','hjdxz','jljdjg','jlrq','jyaq','pzajbh','pzflwsh','pzrybh','sdnjccjg',
            //  'sdnjcjsj','sdnjdw','sdnjjcr','sypz','sypzwsh','syr']);
            /**布局初始化**/
        },
