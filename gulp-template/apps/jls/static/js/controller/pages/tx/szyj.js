...
define(function(require){
    ...
    var formtpl=require('services/form/_txSzyj.html');
    ...
    var form=require('modules/form/_txSzyj');

    require('layer.config');
    var utils = require('awd/layui/utils');
    var combox = require('awd/easyui/combox');
    var hdpzFormAdd = require('modules/form/_txSzyj');
            ...
            toolbar.init({
                buttons: [
                    { id: 'add', name: '办理登记', icon: 'icon-taizhang', fun: function() {
                        ...
                        if (data) {
                            hdpzFormAdd.init(url.szyjSave, data, function() {
                                grid.reload('table');
                            });
                        } else {
                            utils.alert("请选择人员");
