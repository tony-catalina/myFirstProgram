...
define(function(require){
    ...
    var formtpl=require('services/form/_txXwdj.html');
    ...
    var form=require('modules/form/_txXwdj');
    ...
    var main={
        ...
        layout:function(){
            ...
            //     columns: clumn({
            //         check: false,
            //         clumns: ['xm','jsh','bm','xb','rsrq','rsxz','badw','bar','bardh','gyqx','gyts','hjd','hyzk','mz','sf','tssf','whcd','xzd','zjlx','zjh','zy','zzmm','gzdw','hjdxz',
