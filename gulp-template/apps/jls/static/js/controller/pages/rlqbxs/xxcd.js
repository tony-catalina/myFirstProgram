...
define(function(require){
    ...
    var formtpl=require('services/form/_rlqbxsXxcd.html');
    ...
    var form=require('modules/form/_rlqbxsXxcd');
            ...
            toolbar.init({
                buttons:[
                    {id:'add',name:'办理登记',icon:'icon-jiahao',fun:function(){
                            ...
                            if (data) {
                                form.init(url.xsdjexecuteflow, data, function() {
                                    grid.reload('table');
                                });
                            } else {
                                utils.alert('请选择人员');
            ...
            searchform.initLc('search',{
            	...
            	query:function(param){
            		   param=$.extend({}, {
            							 ...
            							 'taskDefinitionKey': 'jls_rlqbxsxx_xxcd'
            						}, param);
