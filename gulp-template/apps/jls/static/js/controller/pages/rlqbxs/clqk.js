...
define(function(require){
    ...
    var formtpl=require('services/form/_rlqbxsClqk.html');
    ...
    var form=require('modules/form/_rlqbxsClqk');

    require('layer.config');
    var utils = require('awd/layui/utils');
    var combox = require('awd/easyui/combox');
    var hdpzFormAdd = require('modules/form/_rlqbxsClqk');
        ...
        layout:function(){
            ...
            toolbar.init({
                buttons:[
                    {id:'add',name:'办理登记',icon:'icon-jiahao',fun:function(){
                            ...
                            if (data) {
                                hdpzFormAdd.init(url.xsdjexecuteflow, data, function() {
                                    grid.reload("table");
                                });
                            } else {
                                utils.alert("请选择人员");
            ...
            searchform.initLc('search',{
            	...
            	query:function(param){
            		   param=$.extend({}, {
										 'state':'R8',
            							 'processDefinitionKey': 'jls_rlqbxsxx',
            							 'taskDefinitionKey': 'jls_rlqbxsxx_clqk'
            						}, param);
            ...
            jbxxgrid.initJbxxflow('table',false,200, {
                'processDefinitionKey': 'jls_rlqbxsxx',
                'taskDefinitionKey': 'jls_rlqbxsxx_czqk'
            },function(rybh) {
            });
            // grid.init('table',{
            ...
            //                      clumns:['xm','jsh','bm','xbString','rsrq','ayString','cssj','badw','gyqx','gyts','jsbh','rybh','tbr','tbrq','wbrybh','gcbh','ywlcid','taskid','snbh',
            ...
            //                          'czzt','jsly','byjswsh','jsrq','zxf','aqdj','rygllb','lscsyy','lscssj','lscshssj','crjbj','rkbhgbj','rkbhgyy','lrsfjs','csyy','csqx',
            ...
            //                         'lscshssj','crjbj','rkbhgbj','rkbhgyy','lrsfjs','csyy','csqx','jj','jb','zdzy','ygry','yfh','cwh','fwh','rsldsp','rsldspnr','rsldqm',
            ...
            //     ['xm','jsh','bm','xbString','rsrq','cssj','ayString','badw','gyqx','gyts','jsbh','rybh','tbr','tbrq','wbrybh','gcbh','ywlcid','taskid','snbh',
            //         'zjlx','zjh','gj','whcd','sf','tssf','mz','zzmm','csrq','hyzk','hjd','hjdxz','jg','xzd','xzdxz','gzdw','zy','jljdjg','bar','rsxz','syr',
            //         'sypz','barjh','bardh','czdh','jlrq','sdnjccjg','sdnjdw','sdnjcjsj','sdnjjcr','jyaq','dah','hzflwsh','pzrybh','pzajbh','pzflwsh',
            //         'czzt','jsly','byjswsh','jsrq','zxf','aqdj','rygllb','lscsyy','lscssj','lscshssj','crjbj','rkbhgbj','rkbhgyy','lrsfjs','csyy','csqx',
            //         'jj','jb','zdzy','ygry','yfh','cwh','fwh','rsldsp','rsldspnr','rsldqm','rsldqmsj','state','scbz','dwlx','wfdd','sydw','creator','createtime',
