...
define(function(require){
    ...
    var form=require('modules/form/_swPfwp');
        ...
        layout:function(){
            ...
            toolbar.init({
                buttons: [
                    { id: 'add', name: '办理登记', icon: 'icon-taizhang', fun: function() {
                            ...
                            if (data) {
                                form.init(url.pfwpSave, data, function() {
                                    grid.reload('table');
                                });
                            } else {
                                utils.alert('请选择人员');
            ...
            searchform.initLc('search', {
                query:function(param){
                    param=$.extend({}, {
                                     'processDefinitionKey':'jls_jssw',
                                     'taskDefinitionKey':'jls_jssw_pfwp'
                                 }, param);
            ...
            //     columns: clumn({
            //         check: false,
            //         clumns: ['xm','jsh','bm','xb','ayString','rsrq','rsxz','badw','bar','bardh','gyqx','gyts','hjd','hyzk','mz','sf','tssf','whcd','xzd','zjlx','zjh','zy','zzmm','gzdw','hjdxz',
            ...
            //     ['xm','jsh','bm','xb','ayString','rsrq','rsxz','badw','bar','bardh','gyqx','gyts','hjd','hyzk','mz','sf','tssf','whcd','xzd','zjlx','zjh','zy','zzmm','gzdw','hjdxz','jljdjg','jlrq','jyaq','pzajbh','pzflwsh','pzrybh','sdnjccjg','sdnjcjsj','sdnjdw','sdnjjcr','sypz','sypzwsh','syr'],
