...
define(function(require){
    ...
    var gjcxZsryFormAdd = require('modules/form/_gjcxZsry');
    ...
    var main={
        ...
        layout:function(){
            ...
            toolbar.init({
                buttons: [
                    { id: 'add', name: '高级查询', icon: 'icon-taizhang', fun: function() { 
                        ...
                        // if (data) {
                            gjcxZsryFormAdd.init(url.jbxxList, {}, function() {});
                        // } else {
            ...
            //     ['xm','jsh','bm','xb','rsrq','rsxz','badw','ayString','bar','bardh','gyqx','gyts','hjd',
            // 'hyzk','mz','sf','tssf','whcd','xzd','zjlx','zjh','zy','zzmm','gzdw','hjdxz',
            // 'jljdjg','jlrq','jyaq','pzajbh','pzflwsh','pzrybh','sdnjccjg','sdnjcjsj','sdnjdw','sdnjjcr',
            // 'sypz','sypzwsh','syr'],
            //     ['xb','rsxz','bar','bardh','hjd','hyzk','mz','sf','tssf','whcd','xzd','zjlx','zjh',
            // 'zy','zzmm','gzdw','hjdxz','jljdjg','jlrq','jyaq','pzajbh','pzflwsh','pzrybh','sdnjccjg',
            //  'sdnjcjsj','sdnjdw','sdnjjcr','sypz','sypzwsh','syr']);
