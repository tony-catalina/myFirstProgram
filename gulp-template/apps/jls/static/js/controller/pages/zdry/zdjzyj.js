...
define(function (require) {
    ...
    var formtpl = require('services/form/_zdryZdjzyj.html');
    var hideshow = require('modules/showHideClumn');
    var form = require('modules/form/_zdryZdjzyj');


    require('layer.config');
    var utils = require('awd/layui/utils');
    var combox = require('awd/easyui/combox');
    var hdpzFormAdd = require('modules/form/_zdryZdjzyj');
    ...
    var main = {
        ...
        layout: function () {
            ...
            toolbar.init({
                buttons: [{
                    ...
                    fun: function () {
                        ...
                        if (data) {
                            hdpzFormAdd.init(url.zdryzdyj, data, function () {
                                grid.reload('table');
                            });
                        } else {
                            utils.alert("请选择人员");
            ...
            searchform.initLc('search', {
                ...
                //             title: '案别',
                //             type: 'awdCombox',
                //             url: url.getDictionary + '?node=JLSAJLB'
                //         },
                //         {
                //             name: 'xb',
                //             title: '性别',
                ...
                query: function (param) {
                    param = $.extend({}, {
                        'processDefinitionKey': 'jls_zdrysc',
                        'taskDefinitionKey': 'jls_zdrysc_jcyj'
                    }, param);
