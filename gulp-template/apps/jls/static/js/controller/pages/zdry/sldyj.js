...
define(function(require){
    ...
    var form=require('modules/form/_zdrySldyj');

            
    require('layer.config');
    var utils = require('awd/layui/utils');
    var combox = require('awd/easyui/combox');
    var hdpzFormAdd = require('modules/form/_zdrySldyj');
            ...
            toolbar.init({
                buttons:[
                    {id:'add',name:'办理登记',icon:'icon-jiahao',fun:function(){
                            ...
                            if (data) {
                                hdpzFormAdd.init(url.zdrysldyj, data, function() {
                                    grid.reload('table');
                                });
                            } else {
                                utils.alert("请选择人员");
            ...
            searchform.initLc('search',{
                ...
                query: function (param) {
                    param = $.extend({}, {
                        ...
                        'taskDefinitionKey': 'jls_zdrysc_sldyj'
                    }, param);
