        ...
        layout:function(){
            ...
            grid.init('table',{
                ...
                columns: clumn( {check:false,
                                 clumns:['xm','jsh','zxr','zdqm','zdqmsjString','cpgj','cprqString','ly','zdyjnr'],
                                 hidden:[]})
            });
            hideshow.init('modules/clumn/jcjl',['xm','jsh','zxr','zdqm','zdqmsjString','cpgj','cprqString','ly','zdyjnr'],[]);

           
            glws.init('glws', {
                files:[
                    {name:'被拘留人奖惩登记表',label:"jls_bjlrjcdjb"}
                ]
            });
