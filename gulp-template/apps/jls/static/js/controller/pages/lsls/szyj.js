...
define(function (require) {
    ...
    var add = require('services/form/_lslsSzyj.html');
    ...
    var hdpzFormAdd = require('modules/form/_lslsSzyj');
            ...
            toolbar.init({
                buttons: [
                    { id: 'bldj', name: '办理登记', icon: 'icon-taizhang', fun: function () { 
                        ...
                        if (data) {
                            hdpzFormAdd.init(url.lscsZxflow+'?type=2', data, function() {
                                grid.reload('table');
                            });
            ...
            searchform.initLc('search', {
                ...
                query: function (param) {
                    param = $.extend({}, {
                        ...
                        'taskDefinitionKey': 'jls_lsls_szyj'
                    }, param);
                    grid.query('table', param);
                }
            });
            jbxxgrid.initJbxxflow('table',false,200, {'processDefinitionKey': 'jls_lsls',
                'taskDefinitionKey': 'jls_lsls_szyj'},function(rybh) {
             });
