...
define(function (require) {
    ...
    var add = require('services/form/_lslsDjcp.html');
    ...
    var hdpzFormAdd = require('modules/form/_lslsDjcp');
    ...
    var main = {
        ...
        layout: function () {
            ...
            toolbar.init({
                buttons: [
                    { id: 'bldj', name: '办理登记', icon: 'icon-taizhang', fun: function () { 
                        ...
                        if (data) {
                            hdpzFormAdd.init(url.lscsZxflow+'?type=1', data, function() {
                                grid.reload('table');
                            });
                            grid.reload('table');
                        } else {
            ...
            //    },
                query: function (param) {
                    param = $.extend({}, {
                        ...
                        'taskDefinitionKey': 'jls_lsls_djcp'
                    }, param);
            ...
            jbxxgrid.initJbxxflow('table',false,200, {'processDefinitionKey': 'jls_lsls',
                'taskDefinitionKey': 'jls_lsls_djcp'},function(rybh) {
             });
