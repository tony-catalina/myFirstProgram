...
define(function (require) {
    ...
    var form = require('modules/form/_cszlYscp');
                ...
                buttons: [
                    {
                        ...
                        fun: function () {
                            ...
                            if (data) {
                                form.init(url.swjyaddflow, data, function () {
                                    grid.reload('table');
                                });
                            } else {
