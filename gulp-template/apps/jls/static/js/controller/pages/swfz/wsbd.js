        ...
        layout:function(){
            ...
            grid.init('table',{
                ...
                columns: clumn( {check:false,
                                 clumns:['xm','jsh','sar','afsj','jjrq','czqk','phxsajs','jbxx_xb'],
                                 hidden:[]})
            });
            hideshow.init('modules/clumn/swfz',['xm','jsh','sar','afsj','jjrq','czqk','phxsajs','jbxx_xb'],[]);

           
            glws.init('glws', {
                files:[
                    {name:"违法犯罪线索转递函",label:"jls_wffzxszdf"}
                ]
            });
