...
define(function(require){
    ...
    var formtpl=require('services/form/_swfzZcdx.html');
    var hideshow=require('modules/showHideClumn');
    var form=require('modules/form/_swfzZcdx');
            ...
            toolbar.init({
                buttons:[
                    {id:'add',name:'办理登记',icon:'icon-jiahao',fun:function(){
                            ...
                            if (data) {
                                form.init('/jls/swfz/swfzExecuteflow', data, function() {
                                    grid.reload('table');
                                });
                            } else {
                                utils.alert('请选择人员');
            ...
            searchform.initLc('search',{
            	...
            	query:function(param){
            		   param=$.extend({}, {
            							 ...
            							 'taskDefinitionKey':'jls_swfz_zcdx'
            						}, param);
            	    grid.query('table',param);
            	 }
            });
            jbxxgrid.initJbxxflow('table',false,200, {'taskDefinitionKey':'jls_swfz_zcdx',
