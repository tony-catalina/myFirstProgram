...
define(function(require){
    ...
    var formtpl=require('services/form/_swfzCdfk.html');
    var hideshow=require('modules/showHideClumn');
    var swfzCdfkForm=require('modules/form/_swfzCdfk');
    ...
    var main={
        ...
        layout:function(){
            ...
            toolbar.init({
                buttons:[
                    {id:'add',name:'办理登记',icon:'icon-jiahao',fun:function(){
                            ...
                            if (data) {
                                swfzCdfkForm.init(url.swfzExecuteflow, data, function() {grid.reload('table');});
                            } else {
                                utils.alert('请选择人员');
                            }
                    }}
            ...
            searchform.initLc('search',{
				...
				query:function(param){
					   param=$.extend({}, {
										 ...
										 'taskDefinitionKey':'jls_swfz_cdfk'
									}, param);
				    grid.query('table',param);
				 }
            });
            jbxxgrid.initJbxxflow('table',false,200, {'taskDefinitionKey':'jls_swfz_cdfk',
            ...
            //                      clumns:['xm','jsh','bm','xb','rsrq','ay','badw','gyqx','gyts'],
            //                      hidden:[]})
            // });
            // hideshow.init('modules/clumn/jbxx',['xm','jsh','bm','xb','rsrq','ay','badw','gyqx','gyts'],[]);
