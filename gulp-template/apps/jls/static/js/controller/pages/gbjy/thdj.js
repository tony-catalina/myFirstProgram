...
define(function (require) {
    ...
    var form = require('modules/form/_gbjyThdj');

    require('layer.config');
    var utils = require('awd/layui/utils');
    var combox = require('awd/easyui/combox');
    var hdpzFormAdd = require('modules/form/_gbjyThdj');
    ...
    var main = {
        ...
        layout: function () {
            ...
            toolbar.init({
                buttons: [{
                    ...
                    fun: function () {
                        ...
                        if (data) {
                            hdpzFormAdd.init(url.gbjyThjySave, data, function () {
                                grid.reload('table');
                            });
                        } else {
                            utils.alert("请选择人员");
            ...
            //             'sypz', 'barjh', 'bardh', 'czdh', 'glrq', 'sdnjccjg', 'sdnjdw', 'sdnjcjsj', 'sdnjjcr', 'jyaq', 'dah', 'hzflwsh', 'pzrybh', 'pzajbh', 'pzflwsh',
            ...
            //             'hjd', 'hjdxz', 'jg', 'xzd', 'xzdxz', 'gzdw', 'zy', 'jljdjg', 'bar', 'rsxz', 'syr', 'sypz', 'barjh', 'bardh', 'czdh', 'glrq', 'sdnjccjg', 'sdnjdw',
