...
define(function(require){
    ...
    var form=require('modules/form/_dwkfWbdj');
    ...
    var main={
        ...
        layout:function(){
            ...
            searchform.initLc('search', {
                ...
                query:function(param){
                    param=$.extend({}, {
                                     ...
                                     'taskDefinitionKey':'jls_dwkf_wbdj'
                                 }, param);
            ...
            hideshow.init('modules/clumn/dwkfYwlc',
                ['kfsj','dwkf_kflxString','cgdx','cgrs','dwmc','sqly','szyj','szyjnr','szqm','szqmsj','sjldyj','sjldyjnr','sjldqm','sjldqmsj','kskfsj','kfdd','sqr','sqdh'],
