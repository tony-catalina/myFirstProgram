...
define(function(require){
    ...
    var form=require('modules/form/_dwkfSjsc');

    require('layer.config');
    var utils = require('awd/layui/utils');
    var combox = require('awd/easyui/combox');
    var hdpzFormAdd = require('modules/form/_dwkfSjsc');
        ...
        layout:function(){
            ...
            toolbar.init({
                buttons: [
                    { id: 'add', name: '办理登记', icon: 'icon-taizhang', fun: function() {
                        //hdpzFormAdd.init('/jls/dwkf/saveBySzyj', {}, function() {});
                        var data = grid.getSelected('table')[0];
                        if (data) {
                            hdpzFormAdd.init(url.dwkfSaveBySzyj, data, function() {});
                        } else {
                            utils.alert("请选择人员");
                        }
                     } }
            ...
            searchform.init('search', {
                ...
                query:function(param){
                    param=$.extend({}, {
                                     ...
                                     'taskDefinitionKey':'jls_dwkf_sjsc'
                                 }, param);
            ...
            grid.init('table', {
                ...
                columns: clumn({
                    ...
                    hidden: ['szyj','szyjnr','szqm','szqmsj','sjldyj','sjldyjnr','sjldqm','sjldqmsj','kskfsj','kfdd','sqr','sqdh']
                })
            });
             hideshow.init('modules/clumn/dwkfYwlc',
                 ...
                 ['szyj','szyjnr','szqm','szqmsj','sjldyj','sjldyjnr','sjldqm','sjldqmsj','kskfsj','kfdd','sqr','sqdh']);
            /**布局初始化**/
        },
        eventBind:function(){
