...
define(function(require){
    ...
    var formtpl=require('services/form/_aqxxyglXxygl.html');
    var utils =require('awd/layui/utils');
    ...
    var form=require('modules/form/_aqxxyglXxygl');
            ...
            toolbar.init({
                buttons:[
                    {id:'add',name:'办理登记',icon:'icon-jiahao',fun:function(){
                            ...
                            if (data) {
                                form.init(url.emdjAndXxygl, data, function() {
                                    grid.reload('table');
                                });
                            } else {
                                utils.alert('请选择人员');
            ...
            searchform.init('search',{
                ...
                query:function(param){
                    param=$.extend({}, {
                        ...
                        'taskDefinitionKey': 'jls_aqxxygl_xxygl'
                    }, param);
