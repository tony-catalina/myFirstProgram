...
define(function(require){
    ...
    var formtpl=require('services/form/_aqxxyglCxdj.html');
    ...
    var form=require('modules/form/_aqxxyglCxdj');
    ...
    var main={
        ...
        layout:function(){
            ...
            toolbar.init({
                buttons:[
                    {id:'add',name:'办理登记',icon:'icon-jiahao',fun:function(){
                            ...
                            if (data) {
                                form.init(url.emdjExecuteflow, data, function() {
                                    grid.reload('table');
                                });
                            } else {
                                utils.alert('请选择人员');
            ...
            searchform.initLc('search',{
            	...
            	query:function(param){
            		   param=$.extend({}, {
            							 ...
            							 'taskDefinitionKey': 'jls_aqxxygl_cxdj'
            						}, param);
            ...
            //                      'zjlxString','zjh','gj','whcd','sf','tssf','mz','zzmm','csrq','hyzk',
