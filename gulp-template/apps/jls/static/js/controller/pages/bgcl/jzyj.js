...
define(function (require) {
    ...
    var add = require('services/form/_bgclJzyj.html');
    ...
    var jshjHjdjForm = require('modules/form/_bgclJzyj');
            ...
            toolbar.init({
                buttons: [
                    { id: 'bldj', name: '办理登记', icon: 'icon-taizhang', fun: function () {
                        ...
                        if(data) {
                            jshjHjdjForm.init(url.clcsSpAdd+'?yjlx=1', data, function() {
                                grid.reload('table')
                            });
                            grid.reload('table');
                        }else {
               ...
               pageRender:{
                ...
                query: function (param) {
                    param = $.extend({}, {
                        ...
                        'taskDefinitionKey': 'jls_bgcl_jzyj'
                    }, param);
                    grid.query('table', param);
                }
            });
            jbxxgrid.initJbxxflow('table',false,200, {'processDefinitionKey': 'jls_bgcl',
                'taskDefinitionKey': 'jls_bgcl_jzyj'},function(rybh) {
