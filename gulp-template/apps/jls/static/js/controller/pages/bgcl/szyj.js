...
define(function (require) {
    ...
    var add = require('services/form/_bgclSzyj.html');
    ...
    var hdpzFormAdd = require('modules/form/_bgclSzyj');
                ...
                buttons: [
                    { id: 'bldj', name: '办理登记', icon: 'icon-taizhang', fun: function () {
                        var data = grid.getSelected('table')[0];
                          if (data) {
                              hdpzFormAdd.init(url.clcsSpAdd+'?yjlx=2', data, function() {
                                grid.reload('table');
                              });
               ...
               pageRender:{
                ...
                query: function (param) {
                    param = $.extend({}, {
                        ...
                        'taskDefinitionKey': 'jls_bgcl_szsp'
                    }, param);
                    grid.query('table', param);
                }
            });
            jbxxgrid.initJbxxflow('table',false,200, {'processDefinitionKey': 'jls_bgcl',
                'taskDefinitionKey': 'jls_bgcl_szsp'},function(rybh) {
             });
