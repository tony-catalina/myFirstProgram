...
define(function (require) {
    ...
    var add = require('services/form/_bgclLs.html');
    ...
    var hdpzFormAdd = require('modules/form/_bgclLs');
                ...
                buttons: [
                    { id: 'bldj', name: '办理登记', icon: 'icon-taizhang', fun: function () {
                         var data = grid.getSelected('table')[0];
                           if (data) {
                               hdpzFormAdd.init(url.bgclLs+'?type=2', data, function() {
                                grid.reload('table');
                               });
               ...
               pageRender:{
                ...
                query: function (param) {
                    param = $.extend({}, {
                        ...
                        'taskDefinitionKey': 'jls_bgcl_ls'
                    }, param);
                    grid.query('table', param);
                }
            });
            jbxxgrid.initJbxxflow('table',false,200, {'processDefinitionKey': 'jls_bgcl',
                'taskDefinitionKey': 'jls_bgcl_ls'},function(rybh) {
             });
            /**布局初始化**/
        },
        eventBind: function () {
