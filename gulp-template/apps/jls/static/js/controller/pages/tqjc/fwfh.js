...
define(function (require) {
    ...
    var add = require('services/form/_tqjcFwfh.html');
    ...
    var form=require('modules/form/_tqjcFwfh');
            ...
            toolbar.init({
                buttons: [
                    { id: 'bldj', name: '办理登记', icon: 'icon-taizhang', fun: function () {
                            ...
                            if (data) {
                                form.init(url.tqjcaddFlowWfwth, data, {},function() {
                                    grid.reload('table');
                                });
            ...
            searchform.initLc('search', {
                ...
                query: function (param) {
                    param = $.extend({}, {
                        ...
                        'taskDefinitionKey': 'jls_tqjc_fwth'
                    }, param);
                    grid.query('table', param);
                }
            });
            jbxxgrid.initJbxxflow('table',false,200, {'processDefinitionKey': 'jls_tqjc',
                'taskDefinitionKey': 'jls_tqjc_fwth'},function(rybh) {
             });
            /**布局初始化**/
        },
        eventBind: function () {
