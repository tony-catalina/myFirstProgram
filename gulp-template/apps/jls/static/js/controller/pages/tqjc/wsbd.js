    ...
    var main = {
        ...
        layout: function () {
            ...
            grid.init('table', {
                ...
                columns: clumn({
                    check: false,
                    clumns: ['jbxx_jsh', 'jbxx_xm','tqjcjlqxString','gjqm','jzyj','szyjnr'],
                    hidden: []
                })
            });
            hideshow.init('modules/clumn/clcs',['jbxx_jsh', 'jbxx_xm','tqjcjlqxString','gjqm','jzyj','szyjnr'], []);

            glws.init('glws', {
                files: [
                    { name: "解除拘留证明书",label:"jls_jcjlzms" },
                    { name: "建议停止执行拘留通知书",label:"jls_jytzzxjltzs" }
                ]
            });
