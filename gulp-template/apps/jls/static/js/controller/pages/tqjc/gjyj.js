...
define(function (require) {
    ...
    var add = require('services/form/_tqjcGjyj.html');
    ...
    var bldjFormAdd = require('modules/form/tqjcGjyj');
    ...
    var main = {
        ...
        layout: function () {
            ...
            toolbar.init({
                buttons: [
                    { id: 'bldj', name: '管教意见', icon: 'icon-taizhang', fun: function () {
                       
                            var data = grid.getSelected('table')[0];
                            if (data) {
                                bldjFormAdd.init(url.tqjcGjyj, data, function() {
                                    grid.reload('table');
                                });
            ...
            //     })
            // });
            // hideshow.init('modules/clumn/jbxx',['xm', 'jsh', 'bm', 'xb', 'rsrq', 'rsxz', 'ay', 'badw', 'bar', 'bardh', 'hjd', 'hyzk', 'mz', 'gyts', 'jlrq', 'gyqx','xb', 'rsxz', 'bar', 'bardh', 'hjd', 'hyzk', 'mz', 'jlrq'],
