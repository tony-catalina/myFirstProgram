...
define(function(require){
    ...
    var formtpl=require('services/form/_ldjfJdqkdj.html');
    var hideshow=require('modules/showHideClumn');
    var form=require('modules/form/_ldjfJdqkdj')

    require('layer.config');
    var utils = require('awd/layui/utils');
    var combox = require('awd/easyui/combox');
    var hdpzFormAdd = require('modules/form/_ldjfJdqkdj');
                ...
                buttons: [
                    {
                        ...
                        icon: 'icon-taizhang',
                        fun: function () {
                                hdpzFormAdd.init(url.ldjfSave, {}, function() {grid.reload('table');});
