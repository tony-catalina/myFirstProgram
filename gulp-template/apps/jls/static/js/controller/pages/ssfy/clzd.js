...
define(function(require){
    ...
    var form=require('modules/form/_ssfyClzd');
            ...
            toolbar.init({
                buttons:[
                    {id:'add',name:'办理登记',icon:'icon-jiahao',fun:function(){
                            ...
                            if (data) {
                                form.init(url.ssfyUpdate, data, function() {
                                    grid.reload('table');
                                });
                            } else {
                                utils.alert('请选择人员');
            ...
            searchform.initLc('search',{
				query:function(param){
					   param=$.extend({}, {
										  'state': 'R2',
                                        //  'jbxx_state':'R8',
										//  'processDefinitionKey': 'jls_ssfyClcd',
										//  'taskDefinitionKey': 'jls_ssfyClcd_clcd'
									}, param);
