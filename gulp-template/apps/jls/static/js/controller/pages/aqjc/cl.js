...
define(function (require) {
 ...
 //   var add = require('services/form/_aqjcCl.html');
    ...
    var form= require('modules/form/_aqjcCl');
    //界面控件
    var main = {
        init: function () {
            /**界面初始化**/
        ...
        layout: function () {
            ...
            searchform.init('search', {
                ...
                pageRender:{
                    ...
                    more: [
                        [
                            { name: 'aqjcsjksStart', title: '安全检查开始时间',  type: 'datebox'   },
                            { name: 'aqjcsjksEnd', title: '至',  type: 'datebox' }
                        ],
            ...
            grid.init('table', {
                ...
                columns: clumn({
                    ...
                    hidden: ['bz', 'cjrs', 'jsbh', 'jpld', 'ldqrnr', 'bz', 'cjrs', 'jsbh','cljg']
                })
            });
            hideshow.init('modules/clumn/aqjc',
                ['jckssj', 'jcjssj', 'fw', 'cjry', 'wjp', 'aqyh', 'jpld', 'ldqrnr', 'bz','cljg', 'cjrs', 'jsbh'],
                ['bz', 'cjrs', 'jsbh', 'jpld', 'ldqrnr', 'bz', 'cjrs', 'jsbh','cljg']);
            /**布局初始化**/
        },
        eventBind: function () {
            /**事件绑定**/
