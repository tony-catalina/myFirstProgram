...
define(function (require) {
    ...
    var add = require('services/form/_aqjcSldjp.html');
    ...
    var form=require('modules/form/_aqjcSldjp');
    //界面控件
    var main = {
        init: function () {
            /**界面初始化**/
        ...
        layout: function () {
            ...
            toolbar.init({
                buttons: [
                    { id: 'bldj', name: '办理6登记', icon: 'icon-taizhang', fun: function () {
                        ...
                        if (data) {
                            ...
                            // form.init('/jls/aqjc/update',initdata,selected,function(){
