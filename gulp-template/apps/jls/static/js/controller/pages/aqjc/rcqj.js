...
define(function (require) {
    ...
    var add = require('services/form/_aqjcRcqj.html');
    ...
    var form = require('modules/form/_aqjcRcqj');
    //界面控件
    var main = {
        init: function () {
            /**界面初始化**/
        ...
        layout: function () {
            ...
            hideshow.init('modules/clumn/aqjc', ['jckssj', 'jcjssj', 'fw', 'cjry', 'wjp', 'aqyh', 'aqyh', 'jpld', 'ldqrnr', 'bz', 'cjrs', 'jsbh','cljg'],['bz', 'cjrs', 'jsbh']);
