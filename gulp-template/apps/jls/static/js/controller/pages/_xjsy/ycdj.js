...
define(function(require){
    ...
    var formtpl=require('services/form/_xjsyYcdj.html');
    ...
    var form=require('modules/form/_xjsyYcdj');
                            ...
                            if (data) {
                                $.ajax({
                                    ...
                                    success : function(result) {
                                        ...
                                        var addData = Object.assign({dateTime: currentTime,tbr: common.info.user.loginname},data,result.result.rows[0]);
