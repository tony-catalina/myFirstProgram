...
define(function(require){
    ...
    var formtpl=require('services/form/_xjsyJcszyj.html');
    var hideshow=require('modules/showHideClumn');
    var form=require('modules/form/_xjsyJcszyj');
    ...
    var main={
        ...
        layout:function(){
            ...
            toolbar.init({
                buttons:[
                    {id:'add',name:'办理登记',icon:'icon-jiahao',fun:function(){
                            ...
                            if (data) {
                                form.init(url.jjycAndjcByLdsp, data, function() {
                                    grid.reload('table');
                                });
                            } else {
                                utils.alert('请选择人员');
            ...
            searchform.init('search',{
                ...
                query:function(param){
                    param=$.extend({}, {
                        ...
                        'taskDefinitionKey':'jls_xjsy_jcszyj',
                        'sfycjc':'false'
                    }, param);
            ...
            jbxxgrid.initJbxxflow('table',false,200, {
                'processDefinitionKey':'jls_ycjcxjsy',
                'taskDefinitionKey':'jls_ycjcxjsy_szyj'
            },function(rybh) {
            });
            // grid.init('table',{
