...
define(function(require){
    ...
    var form=require('modules/form/_xjsyXjsycp');
    ...
    var main={
        ...
        layout:function(){
            ...
            toolbar.init({
                buttons:[
                    {id:'add',name:'办理登记',icon:'icon-jiahao',fun:function(){
                            ...
                            if (data) {
                                form.init(url.jjaddflow, data, function() {
                                    grid.reload('table');
                                });
                            } else {
                                utils.alert('请选择人员');
            ...
            //         hidden:['jsbh','rybh','xbString','tbr','tbrq','wbrybh','gcbh','ywlcid','taskid','snbh',
            ...
            // });
            // hideshow.init('modules/clumn/jbxx',['xm','jsh','bm','xbString','rsrq','ayString','badw','gyqx','gyts'],['jsbh','rybh','xbString','tbr','tbrq','wbrybh','gcbh','ywlcid','taskid','snbh',
            //     'zjlx','zjh','gj','whcd','sf','tssf','mz','zzmm','csrq','hyzk',
            //     'hjd','hjdxz','jg','xzd','xzdxz','gzdw','zy','jljdjg','bar','rsxz','syr',
            //     'sypz','barjh','bardh','czdh','jlrq','sdnjccjg','sdnjdw',
            //     'sdnjcjsj','sdnjjcr','jyaq','dah','hzflwsh','pzrybh','pzajbh','pzflwsh',
