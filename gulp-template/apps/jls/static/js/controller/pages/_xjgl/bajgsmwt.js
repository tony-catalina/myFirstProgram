...
define(function(require){
    ...
    var formtpl=require('services/form/_xjglBajgsmwt.html');
    var hideshow=require('modules/showHideClumn');
    var form=require('modules/form/_xjglBajgsmwt');
    ...
    var main={
        ...
        layout:function(){
            ...
            toolbar.init({
                buttons:[
                    {id:'add',name:'办理登记',icon:'icon-jiahao',fun:function(){
                            ...
                            if (data) {
                                form.init(url.xjgladdflow, data, function() {
                                    grid.reload('table');
                                });
                            } else {
                                utils.alert('请选择人员');
            ...
            //                      clumns:['xm','jsh','bm','rsrq','ayString','badw','gyqx','gyts','jsbh','rybh','tbr','tbrq','wbrybh','gcbh','ywlcid','taskid','snbh',
            //                          'zjlx','zjh','gj','whcd','sf','tssf','mz','zzmm','csrq','hyzk','hjd','hjdxz','jg','xzd','xzdxz','gzdw','zy','jljdjg','bar','rsxz',
            //                          'syr','sypz','barjh','bardh','czdh','jlrq','sdnjccjg','sdnjdw', 'sdnjcjsj','sdnjjcr','jyaq','dah','hzflwsh','pzrybh','pzajbh','pzflwsh',
            ...
            // });
            // hideshow.init('modules/clumn/jbxx',['xm','jsh','bm','rsrq','ayString','badw','gyqx','gyts','jsbh','rybh','tbr','tbrq','wbrybh','gcbh','ywlcid','taskid','snbh',
            ...
            //     'czzt','jsly','byjswsh','jsrq','zxf','aqdj','rygllb','lscsyy','lscssj','lscshssj','crjbj','rkbhgbj','rkbhgyy','lrsfjs','cssj','csyy','csqx',
            //     'jj','jb','zdzy','ygry','yfh','cwh','fwh','rsldsp','rsldspnr','rsldqm','rsldqmsj','state','scbz','dwlx','wfdd','sydw','creator','createtime',
            //     'updator','updatetime','bhlx','csd','ky','lxdh','hjdszpcs','tmtbtz','dwdz','bjlrjl','bjlrjscfqk','wfsj','fxdj'],['jsbh','rybh','tbr','tbrq','wbrybh','gcbh','ywlcid','taskid','snbh',
            // 'zjlx','zjh','gj','whcd','sf','tssf','mz','zzmm','csrq','hyzk','hjd','hjdxz','jg','xzd','xzdxz','gzdw','zy','jljdjg','bar','rsxz','syr','sypz','barjh','bardh','czdh','jlrq','sdnjccjg','sdnjdw',
            // 'sdnjcjsj','sdnjjcr','jyaq','dah','hzflwsh','pzrybh','pzajbh','pzflwsh','czzt','jsly','byjswsh','jsrq','zxf','aqdj','rygllb','lscsyy','lscssj',
            // 'lscshssj','crjbj','rkbhgbj','rkbhgyy','lrsfjs','cssj','csyy','csqx','jj','jb','zdzy','ygry','yfh','cwh','fwh','rsldsp','rsldspnr','rsldqm',
            // 'rsldqmsj','state','scbz','dwlx','wfdd','sydw','creator','createtime','updator','updatetime','bhlx','csd','ky','lxdh','hjdszpcs','tmtbtz',
            // 'dwdz','bjlrjl','bjlrjscfqk','wfsj','fxdj']);
