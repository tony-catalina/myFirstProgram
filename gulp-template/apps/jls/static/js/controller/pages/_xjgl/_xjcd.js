...
define(function(require){
    ...
    var formtpl=require('services/form/_xjglXjcd.html');
    var hideshow=require('modules/showHideClumn');
    var form =require('modules/form/_xjglXjcd');
        ...
        layout:function(){
            ...
            toolbar.init({
                buttons:[
                    {id:'add',name:'办理登记',icon:'icon-jiahao',fun:function(){
                            ...
                            if (data) {
                                form.init(url.ecuteflow, data, function() {});
                            } else {
                                utils.alert('请选择人员');
                            }
                        }}
            ...
            searchform.initLc('search',{
                ...
                query:function(param){
                    param=$.extend({}, {
                        'processDefinitionKey': 'jls_xjgl',
                        'taskDefinitionKey': 'jls_xjgl_xjcd'
                    }, param);
