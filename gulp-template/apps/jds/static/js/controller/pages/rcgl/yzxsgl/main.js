define(function (__r__, exports, module) {
    ...
    var pageDicts = {
        '业务流程': {
            mod: require('/apps/jds/static/js/controller/pages/rcgl/yzxsgl/ywlc.js')
        },
        '业务台账': {
            mod: require('/apps/jds/static/js/controller/pages/rcgl/yzxsgl/ywtz.js')
        },
        '规范说明': {
            mod: require('/apps/jds/static/js/controller/pages/rcgl/yzxsgl/gfsm.js')
        }
    }
