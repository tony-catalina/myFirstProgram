define(function (__r__, exports, module) {
    ...
    var pageDicts = {
        人员列表: {
            mod: require("/apps/jds/static/js/controller/pages/sjzx/rsxxwh/rylb.js")
        },
        查询条件: {
            mod: require("/apps/jds/static/js/controller/pages/sjzx/rsxxwh/cxtj.js")
        }
    ...
    var initContent = function () {
        ...
        // 初始化默认页面
        tabsContent.appendChild(pageDicts["人员列表"].mod.render());
        // 切换
