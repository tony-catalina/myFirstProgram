define(function (__r__, exports, module) {
    ...
    var pageDicts = {
        '被监管人制卡': {
            mod: require('/apps/jds/static/js/controller/pages/sjzx/dzwd/bjgrzk.js')
        },
        '民警制卡': {
            mod: require('/apps/jds/static/js/controller/pages/sjzx/dzwd/mjzk.js')
        },
    }
    ...
    var initContent = function () {
        ...
        // 初始化默认页面
        tabsContent.appendChild(pageDicts['被监管人制卡'].mod.render());
        // 切换
